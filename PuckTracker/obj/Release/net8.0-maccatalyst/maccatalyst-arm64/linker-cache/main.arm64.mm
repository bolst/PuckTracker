...
extern void *mono_aot_module_PuckTracker_info;
extern void *mono_aot_module_Blazorise_info;
extern void *mono_aot_module_Blazorise_Bootstrap5_info;
extern void *mono_aot_module_Blazorise_Icons_FontAwesome_info;
extern void *mono_aot_module_Blazorise_Licensing_info;
...
extern void *mono_aot_module_Microsoft_AspNetCore_Components_WebView_info;
extern void *mono_aot_module_Microsoft_AspNetCore_Components_WebView_Maui_info;
...
extern void *mono_aot_module_Microsoft_Extensions_FileProviders_Composite_info;
...
void xamarin_register_modules_impl ()
{
	...
	mono_aot_register_module (mono_aot_module_PuckTracker_info);
	mono_aot_register_module (mono_aot_module_Blazorise_info);
	mono_aot_register_module (mono_aot_module_Blazorise_Bootstrap5_info);
	mono_aot_register_module (mono_aot_module_Blazorise_Icons_FontAwesome_info);
	mono_aot_register_module (mono_aot_module_Blazorise_Licensing_info);
	...
	mono_aot_register_module (mono_aot_module_Microsoft_AspNetCore_Components_WebView_info);
	mono_aot_register_module (mono_aot_module_Microsoft_AspNetCore_Components_WebView_Maui_info);
	...
	mono_aot_register_module (mono_aot_module_Microsoft_Extensions_FileProviders_Composite_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "PuckTracker.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
